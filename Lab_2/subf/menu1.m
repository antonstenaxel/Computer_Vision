...
global HDRadioButton1 HDButton1 HDButton2 HDedit1 HDtext1 HDMenuAxes HDpopmenu HDtext2 ;
...
str=strcat(str,'~\bfSigma (\sigma)\rm|Parameter for the gaussian blure|(noise-free image).|No blur is recommended (\it\sigma = 0\rm)|~\it bluredImage = gaussianBlur(Image1,sigma);|');
WriteHelp(str);
...
global HDRadioButton1 HDButton1 HDButton2 HDedit1 HDtext1 HDMenuAxes HDpopmenu HDtext2;
global adgeD MinSize MenuSizeX xsize ysize MenuSizeY MenuPosX MenuPosY;
global ButtHeight ButtWidth ButtDist TextHeight;
...
MenuPosX=xsize*2+3*adgeD;
MenuPosY=ysize*2+3*adgeD-8-MenuSizeY;
set(HDMenuAxes,'Position',[MenuPosX MenuPosY MenuSizeX MenuSizeY]);
% The NEXT button
ButtPosX=MenuPosX+0.5*ButtDist+MenuSizeX/2;
ButtPosY=MenuPosY+MenuSizeY-ButtDist-ButtHeight;
ButtWidth=MenuSizeX/2-1.5*ButtDist;
set(HDButton1,'Position',[ButtPosX ButtPosY ButtWidth ButtHeight]);
 
% The Open button
ButtPosX=MenuPosX+ButtDist;
set(HDButton2,'Position',[ButtPosX ButtPosY ButtWidth ButtHeight]);
...
ButtWidth=MenuSizeX-2*ButtDist;
labelPos=[ButtPosX ButtPosY ButtWidth*0.4 TextHeight-2];
set(HDtext2,'Position',labelPos);

% popupmenu 			

btnPos=[ButtPosX+ButtWidth*0.45 ButtPosY ButtWidth*0.55 ButtHeight];
set(HDpopmenu, 'Position',btnPos);

% checkbutton for Gradient
ButtWidth=MenuSizeX-2*ButtDist;
ButtPosY = ButtPosY-ButtDist-ButtHeight;
labelPos=[ButtPosX ButtPosY ButtWidth*0.8 TextHeight];
set(HDRadioButton1,'Position',labelPos);
...
ButtWidth=MenuSizeX-2*ButtDist;
labelPos=[ButtPosX ButtPosY ButtWidth*0.6 TextHeight];
set(HDtext1,'Position',labelPos);

ButtWidth=MenuSizeX-2*ButtDist;
labelPos = [ButtPosX+0.35*ButtWidth ButtPosY ButtWidth*0.5 TextHeight];
%set(HDedit1,'Position',labelPos);
